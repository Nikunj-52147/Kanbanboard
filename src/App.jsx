      ...
      {adding ? (
        <motion.form layout onSubmit={handleSubmit}>
          ...
          <div className='mt-1.5 flex items-center justify-end gap-1.5'>
            ...
            <button type="submit" className="flex items-center gap-1.5 rounded 
            bg-neutral-50 px-3 py-1.5 text-sm text-neutral-950 transition-colors
...
const DEFAULT_CARDS = [
  ...
  // TODO
  { title: "Reserch DB options for new microservice", id: "5", column: "todo" },
  { title: "Postmortem for outrage", id: "6", column: "todo" },
  { title: "Sync with product on Q3 roadmap", id: "7", column: "todo" },

  // DOING
  { title: "Refactor context providers to use", id: "8", column: "doing" },
  { title: "Add logging to daily CRON", id: "9", column: "doing" },

  // DONE
  {
    title: "Set up DD dashboards for Lamda listener",
    id: "10",
    column: "done ",
  },
];
